---
title: "The workflow of building SFC model on the Polish economy"
...
2.  Start from scratch or use existing model?

-   We decided to use quarterly model of the Danish economy
